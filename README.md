...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ansitable-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12154&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ansitable-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ansitable` can be installed with:

```
conda install ansitable
```

It is possible to list all of the versions of `ansitable` available on your platform with:
